...
void startup()
{
	...
	content.LoadGLTF("myasset/Blender_Project_Files_V1.gltf");
	content.LoadGLTF("myasset/Blender_Project_Files_V2.gltf");
	content.LoadGLTF("myasset/Blender_Project_Files_V3.gltf");
	content.LoadGLTF("myasset/Blender_Project_Files_V4.gltf");
